...
import com.example.basicbankingapp.DB.Transaction_Contracts.TransactionEntry;
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                userArrayList.add(new Users(currentName, accountNumber, phoneNumber, ifscCode, accountBalance, email));
            }
        } finally {
